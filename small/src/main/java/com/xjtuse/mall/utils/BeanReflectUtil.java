...
public class BeanReflectUtil {
     ...
     * @return
     */
    public static Map<String, Object> getFiledMap(Object bean){
        ...
        for (Field field :
            ...
            try {
                ...
                String getName = parGetName(field.getName());
                if(!checkGetMet(methods, getName)){
                    continue;
                }
